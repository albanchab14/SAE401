...
// ==========================================
// 4. Recevoir les données d'inscription (REGISTER SECURISÉ)
// ==========================================
app.post('/register', async (req, res) => {
    ...
    try {
        ...
        // ✨ LA MAGIE BCRYPT : On crypte le mot de passe (10 est le "saltRounds", le niveau de sécurité)
        const hashedPassword = await bcrypt.hash(password, 10);

        // On insère le mot de passe HASHÉ, et plus le mot de passe en clair !
        ...
        console.error(error);
        res.render('register.njk', { page: 'register', error: "Erreur lors de l'inscription." });
    }
});
